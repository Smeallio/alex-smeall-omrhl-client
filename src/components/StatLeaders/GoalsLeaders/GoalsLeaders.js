  ...
  return (
    <article className="goal-leaders">
      <table className="goal-leaders__table">
        ...
        <tbody>
          {sortColumnWrapper(topTwentyFiveGoalScorers(skaterStats)).map((player) => (
            <tr className="goal-leaders__table-row-players" key={player.player_id}>
              ...
              <td
                className="goal-leaders__table-box goal-leaders__table-box-assists"
                data-label="A"
              >
                {player.total_assists}
              </td>
              <td
                className="goal-leaders__table-box goal-leaders__table-box-points"
                data-label="P"
              >
                {player.total_points}
              </td>
